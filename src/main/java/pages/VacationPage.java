...
public class VacationPage {
    ...
    public static final By INPUT_LINKS = By.cssSelector("input:not(#EditVacationRequestStartDate)");

    public static void findInputsWithout1(WebDriver driver, By element) {  Waiter.waitFluentWaitALLElement(driver, element); }
